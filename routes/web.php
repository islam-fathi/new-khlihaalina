...
Route::group(['namespace' => 'Web','middleware'=>['maintenance_mode']], function () {
    ...
    Route::get('search-doctor', 'WebController@search_doctor')->name('search-doctor');
    Route::get('search-pharmacy', 'WebController@search_pharmacy')->name('search-pharmacy');
    Route::get('search-service', 'WebController@search_service')->name('search-service');
    ...
    Route::get('sellers-categories', 'WebController@sellers_categories')->name('sellers-categories');
    Route::get('sellers', 'WebController@all_sellers')->name('sellers'); 
    Route::get('doctors', 'WebController@all_doctors')->name('doctors');
    Route::get('pharmacies', 'WebController@all_pharmacies')->name('pharmacies');
    Route::get('services', 'WebController@all_services')->name('services');
    ...
    Route::post('review-list-doctor','WebController@review_list_doctor')->name('review-list-doctor');
    Route::post('review-list-pharmacy','WebController@review_list_pharmacy')->name('review-list-pharmacy');
    Route::post('review-list-service','WebController@review_list_service')->name('review-list-service'); 
    ...
    Route::get('doctor-appointments', 'UserProfileController@doctor_appointments')->name('doctor-appointments');
    Route::get('pharmacy-orders', 'UserProfileController@pharmacy_orders')->name('pharmacy-orders');
    Route::get('service-orders', 'UserProfileController@service_orders')->name('service-orders');
    ...
    Route::get('doctor-appointment-details', 'UserProfileController@doctor_appointment_details')->name('doctor-appointment-details')->middleware('customer');
    Route::get('pharmacy-order-details', 'UserProfileController@pharmacy_order_details')->name('pharmacy-order-details')->middleware('customer');
    Route::get('service-order-details', 'UserProfileController@service_order_details')->name('service-order-details')->middleware('customer');
    ...
    Route::get('submit-review-type/{type}/{id}','UserProfileController@submit_review_type')->name('submit-review-type'); 
    ...
    Route::post('review-other-type', 'ReviewController@other_type_store')->name('review-other-type.store');
    ...
    //doctor
    Route::get('doctorView/{id}', 'WebController@doctor_shop')->name('doctorView');
    Route::get('pharmacyView/{id}', 'WebController@pharmacy_shop')->name('pharmacyView');
    Route::get('serviceView/{id}', 'WebController@service_shop')->name('serviceView');
    Route::group(['middleware'=>['customer']], function () {
        Route::post('doctorAppointment/{id}', 'WebController@doctorAppointment')->name('doctor-appointment');
        Route::post('pharmacyOrder/{id}', 'WebController@pharmacy_order')->name('pharmacy-order');
        Route::post('serviceOrder/{id}', 'WebController@service_order')->name('service-order');
    });
