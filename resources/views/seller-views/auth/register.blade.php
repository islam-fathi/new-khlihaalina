                    ...
                    <div class="col-lg-12">
                        <div class="p-5">
                            <div class="text-center mb-2 ">
                                <h3 class=""> {{ \App\CPU\translate('Shop') }} {{ \App\CPU\translate('Application') }}
                                </h3>
                                <hr>
                            </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <div class="pass invalid-feedback">{{ \App\CPU\translate('Repeat') }}
                                            {{ \App\CPU\translate('password') }} {{ \App\CPU\translate('not match') }} .
                                        </div>
                                    </div>
                                </div>
                                <div class="">
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            ...
                                            <select class="js-example-basic-multiple form-control" name="category_id"
                                                onchange="getRequest('{{ url('/') }}/admin/sellers/get-categories?parent_id='+this.value,'seller-sub-category-select','select')"
                                                required>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <select class="js-example-basic-multiple form-control" name="sub_category_id"
                                                id="seller-sub-category-select"
                                                onchange="getRequest('{{ url('/') }}/admin/sellers/get-categories?parent_id='+this.value,'seller-sub-sub-category-select','select')">
                                            </select>
                                        </div>
                                        <div class="col-md-4">
                                            ...
                                            <select class="js-example-basic-multiple form-control" name="sub_sub_category_id"
                                                id="seller-sub-sub-category-select">
                                            </select>
                                        </div>
                                    </div>
                                </div>
                                <h5 class="black">{{ \App\CPU\translate('Working Hours') }}</h5>
                                <div class="form-group row">
                                    <div class="col-sm-6 mb-3 mb-sm-0 ">
                                        <input type="time" class="form-control form-control-user" 
                                            name="working_from_time" placeholder="{{ \App\CPU\translate('working_from_time') }}"
                                            value="{{ old('working_from_time') }}"required>
                                    </div>
                                    <div class="col-sm-6 mb-3 mb-sm-0 ">
                                        <input type="time" class="form-control form-control-user" 
                                            name="working_to_time" placeholder="{{ \App\CPU\translate('working_to_time') }}"
                                            value="{{ old('working_to_time') }}"required>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    <div class="col-md-6">
                                        <select class="form-control" name="city" style="width: 100%">
                                            <option value="0" selected disabled>---{{ \App\CPU\translate('Select City') }}---</option>
                                ...
                                <div class="">
                                    ...
                                    <div class="form-group d-flex flex-wrap justify-content-between">
                                        ...
                                        <div class="form-group mb-1">
                                            ...
                                            <label class=""
                                                for="remember">{{ \App\CPU\translate('i_agree_to_Your_terms') }}<a
