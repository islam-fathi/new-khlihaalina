                            ...
                            @foreach (json_decode($language) as $lang)
                                ...
                                <div class="{{ $lang != 'en' ? 'd-none' : '' }} lang_form" id="{{ $lang }}-form">
                                    ...
                                    <div class="form-group pt-4">
                                        ...
                                        <textarea name="description[]" class="textarea" style="display:none" required>{!! $translate[$lang]['description'] ?? $product['details'] !!}</textarea>
                                    </div>
                                </div>
                            @endforeach
                        </div>
                            ...
                            <div class="col-md-12" style="padding-top: 20px">
                                @if ($product['request_status'] == 2)
                                    <button type="button" onclick="check()"
                                        class="btn btn-primary">{{ \App\CPU\translate('resubmit') }}</button>
                                @else
                                    <button type="button" onclick="check()"
