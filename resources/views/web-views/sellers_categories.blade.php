...
@section('content')
    ...
    <div class="d-flex justify-content-center align-items-center mb-3"
        ...
        <div class="row text-capitalize">
            {{-- <span style="font-weight: 600;font-size: 18px;">{{ str_replace('_', ' ', $data['data_from']) }}
                {{ \App\CPU\translate('Sellers') }} {{ isset($brand_name) ? '(' . $brand_name . ')' : '' }}</span> --}}
        </div>
    ...
    <div class="container pb-5 mb-2 mb-md-4 rtl"
        ...
        <div class="row">
                                                ...
                                                <div class=" for-hover-lable card-header p-1 flex-between">
                                                    <div>
                                                        <label style="cursor: pointer"
                                                            onclick="location.href='{{ route('sellers-categories', ['id' => $child['id'], 'data_from' => 'category', 'page' => 1]) }}'">
                                                            {{ $child['name'] }}
                                                        </label>
                                                    </div>
                                                    <div>
                                                ...
                                                <div class="card-body {{ Session::get('direction') === 'rtl' ? 'mr-2' : 'ml-2' }}"
                                                    ...
                                                    @foreach ($child->childes as $ch)
                                                        <div class="card-header p-1">
                                                            <label class="for-hover-lable" style="cursor: pointer"
                                                                onclick="location.href='{{ route('sellers-categories', ['id' => $ch['id'], 'data_from' => 'category', 'page' => 1]) }}'">{{ $ch['name'] }}</label>
                                                        </div>
                                                    @endforeach
                                                </div>
                                            @endforeach
                    ...
                    <div class="" id="shop-sidebar" style="margin-bottom: 11px;">
                        ...
                        <div class="">
                            ...
                            <div class="widget cz-filter mb-4 pb-4 border-bottom mt-2">
                                <h3 class="widget-title" style="font-weight: 700;">{{ \App\CPU\translate('brands') }}
                                </h3>
                                <div class="divider-role"
                                    style="border: 1px solid whitesmoke; margin-bottom: 14px;  margin-top: -6px;"></div>
                                <div class="input-group-overlay input-group-sm mb-2">
                    ...
                    <div class="" id="shop-sidebar">
                        <div class="">
                            ...
                            <div class="widget widget-categories mb-4 pb-4 border-bottom">
                                <h3 class="widget-title" style="font-weight: 700;">{{ \App\CPU\translate('categories') }}
                                </h3>
                                <div class="divider-role"
                                    style="border: 1px solid whitesmoke; margin-bottom: 14px;  margin-top: -6px;"></div>
                                <div class="accordion mt-n1" id="shop-categories">
                                    @foreach ($categories as $category)
                                        <div class="card">
                                            ...
                                            <div class="card-body {{ Session::get('direction') === 'rtl' ? 'mr-2' : 'ml-2' }}"
                                                id="collapsem-{{ $category['id'] }}" style="display: none">
                                                @foreach ($category->childes as $child)
                                                    <div class="card-header p-1 flex-between">
                                                        <div>
                                                            <label class="for-hover-lable" style="cursor: pointer"
                                                    ...
                                                    <div class="card-body {{ Session::get('direction') === 'rtl' ? 'mr-2' : 'ml-2' }}"
                                                        id="collapsem-{{ $child['id'] }}" style="display: none">
                                                        @foreach ($child->childes as $ch)
                                                            <div class="card-header p-1">
                                                                <label class="for-hover-lable" style="cursor: pointer"
                                                                    onclick="location.href='{{ route('sellers-categories', ['id' => $ch['id'], 'data_from' => 'category', 'page' => 1]) }}'">{{ $ch['name'] }}</label>
            ...
            <section class="col-lg-9">
                ...
                {{-- </div> --}}
                @if (count($sellers) > 0)
                    <div class="row mt-3" id="ajax-sellers">
                        @include('web-views._ajax-sellers', ['sellers' => $sellers])
                    </div>
                @else
        ...
        function filter(value) {
            $.get({
                ...
                success: function(response) {
                    $('#ajax-sellers').html(response.view);
                },
                complete: function() {
                    $('#loading').hide();
                },
