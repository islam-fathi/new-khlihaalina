...
@section('title',\App\CPU\translate('All Pharmacies Page'))
...
@section('content')
    ...
    <div class="container mb-md-4">
        <div class="row mt-3 mb-3 border-bottom">
            <div class="col-md-8">
                <h4 class="mt-2">{{ \App\CPU\translate('pharmacies') }}</h4>
            </div>
            <div class="col-md-4">
                <form action="{{route('search-pharmacy')}}">
                    @csrf
                    <div class="input-group mb-3">
                        <input type="text" class="form-control"  placeholder="{{\App\CPU\translate('Pharmacy name')}}" name="pharmacy_name" required>
                    ...
                    @foreach($pharmacies as $pharmacy)
                        <div class="col-lg-2 col-md-3 col-sm-4 col-6 px-2 pb-4 text-center">
                            <div class="card-body shadow">
                                <a href="{{route('pharmacyView',['id'=>$pharmacy->id])}}">
                                    ...
                                    <div class="text-center text-dark">
                                        <span class="text-center font-weight-bold small p-1">{{Str::limit($pharmacy->name, 14)}}</span>
                                    </div>
                                </a>
                            </div>
                        </div>
