...
@section('title',\App\CPU\translate('Doctor Page'))

@push('css_or_js')
    @if($doctor['id'] != 0)
        <meta property="og:image" content="{{asset('storage/app/public/doctor')}}/{{$doctor->image}}"/>
        <meta property="og:title" content="{{ $doctor->name}} "/>
        <meta property="og:url" content="{{route('doctorView',[$doctor['id']])}}">
    @else
    ...
    @if($doctor['id'] != 0)
        <meta property="twitter:card" content="{{asset('storage/app/public/doctor')}}/{{$doctor->image}}"/>
        <meta property="twitter:title" content="{{route('doctorView',[$doctor['id']])}}"/>
        <meta property="twitter:url" content="{{route('doctorView',[$doctor['id']])}}">
    @else
...
@section('content')
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body" style="padding: 3px!important; cursor: pointer"
                    onclick="location.href={{ route('doctorView',[$doctor->id])}}">
    ...
    $rating = \App\CPU\ProductManager::get_rating($doctor->reviews);
    ?>
            ...
            <div class="col-md-9 col-12">
                <div class="row">
                                    ...
                                    @foreach (json_decode($doctor->images) as $key => $photo)
                                        <div class="cz-preview-item d-flex align-items-center justify-content-center {{$key==0?'active':''}}"
                                            ...
                                            <img class="cz-image-zoom img-responsive" style="width:100%;height:auto"
                                                ...
                                                data-zoom="{{asset("storage/app/public/doctors/$photo")}}"
                                                alt="Doctor image" width=""> 
                    ...
                    <div class="col-lg-7 col-md-8 col-12 mt-md-0 mt-sm-3" style="direction: {{ Session::get('direction') }}">
                        <div class="details">
                            <span class="mb-2" style="font-size: 22px;font-weight:700;">{{ $doctor->name}}</span>
                            ...
                            <div class="mb-3">
                                ...
                                <span class="ml-2" style="font-size: 12px;font-weight:400">
                            </div>
                                ...
                                <div class=" mt-1">
                                    ...
                                    <div class="px-4 pt-lg-3 pb-3 mb-3 mr-0 mr-md-2"
                                        ...
                                        <div class="tab-content px-lg-3">
                                            ...
                                            <div class="tab-pane fade show active" id="overview" role="tabpanel">
                                                <div class="row pt-2 specification">
                                                    <div class="text-body col-lg-12 col-md-12"
                                                        ...
                                                        <h2>{{ \App\CPU\translate('Doctors Details') }}</h2>
                                                        <ul>
                                                            <li>{{ \App\CPU\translate('Speciality') }}: {{$doctor->specialities['speciality']}}</li>
                                                            <li>{{ \App\CPU\translate('City') }}: {{$doctor->cities['name']}}</li>
                                                            <li>{{ \App\CPU\translate('Address') }}: {{$doctor->address}}</li>
                                                            <li>{{ \App\CPU\translate('Email') }}: {{$doctor->email}}</li>
                                                            <li>{{ \App\CPU\translate('Phone') }}:{{$doctor->phone}}</li>
                                                            <li>{{ \App\CPU\translate('Dates') }}:
                                                                <br>
                                                                @foreach($doctor_dates as $date)
                                                                {{$date->day_name}} - from {{$date->start_time}} - To {{$date->end_time}}
                                                                <br>
                                                                @endforeach
                                            ...
                                            @php($reviews_of_doctor = App\Model\ReviewsOtherType::where('type','doctor')->where('type_id',$doctor->id)->paginate(2))
                                            <div class="tab-pane fade" id="reviews" role="tabpanel">
                                                        ...
                                                        <div class=" row d-flex justify-content-center align-items-center">
                                                            ...
                                                            <div class="col-12 d-flex justify-content-center align-items-center mt-2">
                                                                <span class="text-center">
                                                                    {{$reviews_of_doctor->total()}} {{\App\CPU\translate('ratings')}}
                                                                </span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="row pb-4 mb-3">
                                                    <div style="display: block;width:100%;text-align: center;background: #F3F4F5;border-radius: 5px;padding:5px;">
                                                        <span class="text-capitalize">{{\App\CPU\translate('Doctor Review')}}</span>
                                                    </div>
                                                </div>
                                                <div class="row pb-4">
                                                    <div class="col-12" id="doctor-review-list">
                                                        ...
                                                        @if(count($doctor->reviews)==0)
                                                            <div class="card">
                                                                <div class="card-body">
                                                                    <h6 class="text-danger text-center">{{\App\CPU\translate('doctor_review_not_available')}}</h6>
                                                                </div>
                                                            </div>
                                                        @endif
                                                ...
                                                <div class="row no-gutters">
                                                    <div
                                                        ...
                                                        <h2 class="h4 mb-4 text-center"
                                                            style="color: #030303; font-weight:600;">{{ \App\CPU\translate('Appointment this Doctor') }}
                                                        </h2>
                                                        <form action="{{ route('doctor-appointment',[$doctor->id])}}" method="POST" id="getResponse">
                                                            @csrf
                                                            <div class="row">
                                                                <div class="col-sm-6">
                                                                ...
                                                                <div class="col-sm-6">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input class="form-control email" name="email"
                                                                            type="email" placeholder="{{ \App\CPU\translate('Account@email.com') }}" required="">
                                                                    </div>
                                                                </div>
                                                                <div class="col-sm-6">
                                                                    <div class="form-group">
                                                                ...
                                                                <div class="col-sm-6">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input class="form-control subject" type="text"
                                                                            name="subject" value=""
                                                                            placeholder="{{ \App\CPU\translate('Doctor Short title') }}" required="">
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-12">
                                                                    <div class="form-group">
            ...
            <div class="col-md-3 ">
                <div class="product-details-shipping-details">
                    ...
                    <div class="shipping-details-bottom-border">
                        <div style="padding: 25px;">
                            ...
                            <span>{{ \App\CPU\translate('100% Authentic Doctor') }}</span>
                        </div>
                    </div>
                </div>
                ...
                <div style="padding: 25px;">
                    <div class="row d-flex justify-content-center">
                        ...
                        font-size: 16px;">
                            {{ \App\CPU\translate('Other Doctors') }}
                        </span>
                    </div>
                </div>
                <div style="">
                    
                    @foreach($doctor_city as $d_city)
                        @php($overallRating = \App\CPU\ProductManager::get_overall_rating($d_city->reviews))
                        <div class="flash_deal_product rtl" style="cursor: pointer; height:155px; margin-bottom:10px;"
                            onclick="location.href='{{route('doctorView',$d_city->id)}}'">
                            ...
                            <div class=" d-flex" style="">
                                <div class=" d-flex align-items-center justify-content-center"
                                    ...
                                    <div class="flash-deals-background-image" style="background: {{$web_config['primary_color']}}10">
                                        ...
                                        src="{{asset("storage/app/public/doctors/thumbnail/$d_city->thumbnail")}}"
                                        onerror="this.src='{{asset('public/assets/front-end/img/image-place-holder.png')}}'"/>
                                    </div>
                                </div>
                                    ...
                                    <div>
                                        ...
                                        <div class="flash-product-review">
                                            ...
                                            <label class="badge-style2">
                                                ( {{$d_city->reviews->count()}} )
                                            </label>
                                        </div>
                                        <div>
                                            {{-- @if($d_city->discount > 0)
                                                <strike
                                        ...
                                        <div class="flash-product-price">
                                            {{\App\CPU\Helpers::currency_converter($d_city->visit_cost)}}
    ...
    <div class="container  mb-3 rtl" style="text-align: {{Session::get('direction') === "rtl" ? 'right' : 'left'}};">
        <div class="row flex-between">
            <div class="text-capitalize" style="font-weight: 700; font-size: 30px;margin-left: 5px;">
                <span>{{ \App\CPU\translate('Similar Speciality') }} </span>
            </div>
        ...
        <div class="row mt-4">
            @foreach($similar_specialities as $s_speciality)
                    ...
                    <div class="product-single-hover">
                        <div class=" inline_product clickable d-flex justify-content-center"
                            ...
                            <div class="d-flex d-block" style="cursor: pointer;">
                                <a href="{{route('doctorView',[$s_speciality->id])}}">
                                    <img src="{{asset("storage/app/public/doctors/thumbnail/$s_speciality->thumbnail")}}"
                                        onerror="this.src='{{asset('public/assets/front-end/img/image-place-holder.png')}}'"
    ...
    <a class="btn-scroll-top" href="#top" data-scroll>
        <span class="btn-scroll-top-tooltip text-muted font-size-sm mr-2">{{ \App\CPU\translate('Top') }}</span><i
...
@push('script')
    <script>
        ...
        function load_review()
        {
            ...
            $.ajax({
                    type: "post",
                    url: '{{route('review-list-doctor')}}',
                    data:{
                        type_id:{{$doctor->id}},
                        offset:load_review_count
                    },
                    success: function (data) {
                        $('#doctor-review-list').append(data.doctorReview)
