...
@section('title',\App\CPU\translate('Server Order Details'))
            ...
            <section class="col-lg-9 col-md-9">
                <div class="row">
                    <div class="col-md-6 mb-4">
                        <a class="page-link" href="{{ route('service-orders') }}">
                            ...
                            <tr class="order_table_tr" style="background: {{$web_config['primary_color']}}">
                                <td class="order_table_td">
                                    <div class="order_table_info_div">
                                        ...
                                        <div class="order_table_info_div_2">
                                            <span class="spanTr"> {{$service_order->id}} </span>
                                        </div>
                                    </div>
                                </td>
                                <td class="order_table_td">
                                    <div class="order_table_info_div">
                                        <div class="order_table_info_div_1 py-2">
                                            <span
                                                class="d-block spandHeadO">{{\App\CPU\translate('service_name')}}: </span>
                                        </div>
                                        <div class="order_table_info_div_2">
                                            @isset($service_order->service['name'])
                                                <span class="spanTr"> {{$service_order->service['name']}} </span>
                                            @endisset()
                                            @empty($service_order->service['name'])
                                                <span class="spanTr"> {{\App\CPU\translate('service not found')}}</span>
                                            @endempty()
                                        </div>
                                ...
                                <td class="order_table_td">
                                    <div class="order_table_info_div">
                                        ...
                                        <div class="order_table_info_div_2">
                                            <span
                                                class="spanTr"> {{date('d M, Y',strtotime($service_order->created_at))}} </span>
                                        </div>
                                ...
                                <td class="order_table_td">
                                    <div class="order_table_info_div">
                                        ...
                                        <div class="order_table_info_div_2">
                                            <span class="spanTr">
                                                {{\App\CPU\translate('name')}} : {{$service_order->name}}<br>
                                                {{\App\CPU\translate('phone')}} : {{$service_order->phone}}<br>
                                                {{\App\CPU\translate('email')}} : {{$service_order->email}}
                                            </span>
                                        </div>
                                    </div>
                                </td>
                                <td class="order_table_td">
                                    <div class="order_table_info_div">
                                        ...
                                        <div class="order_table_info_div_2">
                                            <span class="spanTr">
                                                {{$service_order->subject}}<br>
                                                {{$service_order->message}}
                                            </span>
                                        </div>
                                    </div>
                                </td>
                            ...
                            <tbody>
                                <tr>
                                    <div class="row">
                                        <div class="col-md-2">
                                            <td>
                                                <a href="{{route('submit-review-type',['service',$service_order->id])}}" class="btn btn-primary btn-sm d-inline-block w-100 mb-2">{{\App\CPU\translate('review')}}</a>
                                            </td>    
                                        </div>
                                    </div>
                                </tr>
