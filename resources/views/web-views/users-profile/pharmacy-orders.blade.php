...
@section('title',\App\CPU\translate('My Pharmacy Order List'))
    ...
    <div class="container rtl" style="text-align: {{Session::get('direction') === "rtl" ? 'right' : 'left'}};">
        <div class="row">
            ...
            <div class="col-md-9 mt-2 sidebar_heading">
                <h1 class="h3  mb-0 p-3 float-{{Session::get('direction') === "rtl" ? 'right' : 'left'}} headerTitle">{{\App\CPU\translate('my_pharmacy_order')}}</h1>
            </div>
        </div>
    </div>
                    ...
                    <div style="overflow: auto">
                        <table class="table">
                            ...
                            <tr style="background-color: #6b6b6b;">
                                ...
                                <td class="tdBorder">
                                    <div class="py-2"><span
                                            class="d-block spandHeadO"> {{\App\CPU\translate('Pharmacy')}}</span></div>
                                </td>
                                ...
                                <tr>
                                    ...
                                    <td class="bodytr">
                                        @isset($order->pharmacy['name'])
                                            <span class="spanTr"> {{$order->pharmacy['name']}} </span>
                                        @endisset()
                                    ...
                                    <td class="bodytr">
                                        <a href="{{ route('pharmacy-order-details', ['id'=>$order->id]) }}"
