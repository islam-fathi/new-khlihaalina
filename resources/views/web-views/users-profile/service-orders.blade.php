...
@section('title',\App\CPU\translate('My Service Order List'))
    ...
    <div class="container rtl" style="text-align: {{Session::get('direction') === "rtl" ? 'right' : 'left'}};">
        <div class="row">
            ...
            <div class="col-md-9 mt-2 sidebar_heading">
                <h1 class="h3  mb-0 p-3 float-{{Session::get('direction') === "rtl" ? 'right' : 'left'}} headerTitle">{{\App\CPU\translate('my_service_order')}}</h1>
            </div>
        </div>
    </div>
                        ...
                        <table class="table">
                            ...
                            @foreach($service_orders as $order)
                                <tr>
                                    ...
                                    <td class="bodytr">
                                        @isset($order->service['name'])
                                            <span class="spanTr"> {{$order->service['name']}} </span>
                                        @endisset()
                                        @empty($order->service['name'])
                                    ...
                                    <td class="bodytr">
                                        <a href="{{ route('service-order-details', ['id'=>$order->id]) }}"
