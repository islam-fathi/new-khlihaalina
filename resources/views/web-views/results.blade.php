                    ...
                    <div class="pb-0">
                        ...
                        <div class="text-center">
                            <div class="" style="border-bottom: 1px solid #F3F5F9;padding:17px;">
                                <span class="widget-title" style="font-weight: 600;">{{ \App\CPU\translate('filter') }}
                                </span>
                            </div>
                            {{-- <div class="divider-role"
                                 style="border: 1px solid whitesmoke; margin-bottom: 14px;  margin-top: -6px;"></div> --}}
                            <div class="form-inline flex-nowrap {{ Session::get('direction') === 'rtl' ? 'ml-sm-4' : 'mr-sm-4' }} pb-3 for-mobile"
                                ...
                                <label class="opacity-75 text-nowrap for-shoting" for="sorting"
                                    ...
                                    <select
                                        style="background: #ffffff; appearance: auto;width: 100%;border-radius: 5px !important;"
                    ...
                    <div class="mt-3">
                        ...
                        <div class="text-center">
                            <div style="border-bottom: 1px solid #F3F5F9;padding:17px;border-top: 1px solid #F3F5F9;">
                                <span class="widget-title" style="font-weight: 600;">{{ \App\CPU\translate('Price') }}
                                </span>
                            </div>
                            ...
                            <div class="d-flex justify-content-between"
                                ...
                                <div style="width: 20%;background:#1B7FED;width:30px;height:35px;border-radius:3px;"
                                    class="d-flex justify-content-center align-items-center">

                                    <a class="" onclick="searchByPrice()">
                                        <i style="font-size:10px;color:#ffffff"
                        ...
                        <div class="text-center">
                            <div style="border-bottom: 1px solid #F3F5F9;padding:17px;border-top: 1px solid #F3F5F9;">
                                <span class="widget-title"
                                    style="font-weight: 700;">{{ \App\CPU\translate('brands') }}</span>
                            </div>
