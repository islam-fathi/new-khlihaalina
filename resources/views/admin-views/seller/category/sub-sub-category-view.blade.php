...
@section('title', \App\CPU\translate('Seller Sub Sub Category'))
    ...
    <div class="content container-fluid">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item" aria-current="page">{{ \App\CPU\translate('Seller Sub Sub Category') }}</li>
            </ol>
        </nav>
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        {{ \App\CPU\translate('seller_sub_sub_category_form') }}
                    </div>
                    <div class="card-body"
                        style="text-align: {{ Session::get('direction') === 'rtl' ? 'right' : 'left' }};">
                        <form action="{{ route('admin.seller-sub-sub-category.store') }}" method="POST">
                            @csrf
                                    ...
                                    @foreach (json_decode($language) as $lang)
                                        <div class="col-12 form-group {{ $lang != $default_lang ? 'd-none' : '' }} lang_form"
                                            ...
                                            <label class="input-label"
                                                for="exampleFormControlInput1">{{ \App\CPU\translate('Seller_Sub_sub_category') }}
                                                {{ \App\CPU\translate('name') }}
                                                ({{ strtoupper($lang) }})
                                            </label>
                                            <input type="text" name="name[]" class="form-control"
                                                placeholder="{{ \App\CPU\translate('New_seller_Sub_Sub_Category') }}"
                                ...
                                @else
                                    <div class="col-12">
                                        <div class="form-group lang_form" id="{{ $default_lang }}-form">
                                            <label class="input-label">{{ \App\CPU\translate('Seller_Sub_sub_category') }}
                                                {{ \App\CPU\translate('name') }}
                                                ({{ strtoupper($lang) }})</label>
                                            <input type="text" name="name[]" class="form-control"
                                                placeholder="{{ \App\CPU\translate('New_Seller_Sub_Category') }}" required>
                                        </div>
                            ...
                            <div class="col-12 col-md-4">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="cat_id" required>
                                        ...
                                        @foreach (\App\Model\SellerCategories::where(['position' => 0])->get() as $category)
                            ...
                            <div class="col-12 col-md-4">
                                <label for="name">{{ \App\CPU\translate('seller_sub_category') }}
                ...
                <div class="card-header">
                    ...
                    <div class="row flex-between justify-content-between align-items-center flex-grow-1">
                        <div class="col-12 col-md-6">
                            <h5>{{ \App\CPU\translate('seller_sub_sub_category_table') }} <span
                            ...
                            <form action="{{ url()->current() }}" method="GET">
                                <div class="input-group input-group-merge input-group-flush">
                                    ...
                                    <input id="datatableSearch_" type="search" name="search" class="form-control"
                                        placeholder="{{ \App\CPU\translate('Search_by_seller_Sub_Sub_Category') }}"
                        ...
                        <table style="text-align: {{ Session::get('direction') === 'rtl' ? 'right' : 'left' }};"
                            ...
                            <thead class="thead-light">
                                <tr>
                                    ...
                                    <th scope="col">{{ \App\CPU\translate('seller_sub_sub_category_name') }}</th>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a class="btn btn-primary btn-sm edit" style="cursor: pointer;"
                                                ...
                                                href="{{ route('admin.seller-category.edit', [$category['id']]) }}">
                                                <i class="tio-edit"></i>
                                            </a>
    ...
    <script>
        $(document).ready(function() {
            ...
            if (id) {
                ...
                $.ajax({
                    type: 'POST',
                    url: '{{ route('admin.seller-sub-sub-category.getSubCategory') }}',
                    data: {
                        id: id
                    },
        ...
        $(document).on('click', '.delete', function() {
            ...
            Swal.fire({
                ...
                if (result.value) {
                    ...
                    $.ajax({
                        url: "{{ route('admin.seller-sub-sub-category.delete') }}",
                        method: 'POST',
                        data: {
                            id: id
                        },
                        success: function() {
                            toastr.success(
                                '{{ \App\CPU\translate('Seller_Sub_Sub_Category_Deleted_Successfully') }}.'
                                );
                            location.reload();
                        }
                    });
