...
@section('title', 'Services Orders List')
@push('css_or_js')
                            ...
                            <form action="{{ url()->current() }}" method="GET">
                                <div class="input-group input-group-merge input-group-flush">
                                    ...
                                    <select class="form-control" name="search" required>
                                        <option value="">--{{ \App\CPU\translate('Select Service') }}--</option>
                                        ...
                                        <tr class="">
                                            ...
                                            <td class="table-column-pl-0"> 
                                                ...
                                                @empty($order->service['name'])
                                                    {{\App\CPU\translate('service not found')}}
                                                @endempty()
                                            </td>
                                            <td class="table-column-pl-0"> 
                                            ...
                                            <td>
                                                {{-- <div class="hs-unfold float-right col-6"> --}}
                                                    <div class="dropdown  form-control">
                                                        <select name="order_status"
                                                            onchange="service_order_status_{{$l++}}(this.value)"
                                                            class="" data-id="">
                                                ...
                                                {{-- </div> --}}
                                                <script>
                                                    function service_order_status_{{$s++}}(status) {
                                                        Swal.fire({
                                                            ...
                                                            if (result.value) {
                                                                ...
                                                                $.ajax({
                                                                    url: "{{ route('admin.service.order-status') }}",
                                                                    method: 'POST',
                                                                    data: {
                                                                        "id": '{{ $order['id'] }}',
                                                                        "order_status": status
